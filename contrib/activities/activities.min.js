var aMinute=6E4,twoMinutes=12E4,anHour=36E5,twoHours=72E5,aDay=864E5,twoDays=1728E5,aWeek=6048E5,twoWeeks=12096E5,url="/gitolite-activities/",nMin=7,nMax=100,nSel=nMin,interval=1E4,intervalId;
...
function activities(){$("#gl-showall").click(function(a){a.preventDefault();stopActivityUpdate();toggleActivityCount();startActivityUpdate()});void 0===intervalId&&getOptions().then(startActivityUpdate)};